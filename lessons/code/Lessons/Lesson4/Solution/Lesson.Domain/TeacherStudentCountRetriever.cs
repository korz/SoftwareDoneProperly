...
{
    public class TeacherStudentCountRetriever : ITeacherStudentCountRetriever
    {
        public IList<TeacherStudentCount> Retrieve(IEnumerable<Teacher> teachers, IEnumerable<Student> students)
        {
